...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Ledger Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
			...
			<td> <?php $js = 'class="required"'; echo form_dropdown('ccurrency', $currency, isset($default['currency']) ? $default['currency'] : '', $js); ?> &nbsp; <br /> </td>
					...
					<tr>	
						 ...
						 <td>  
						    <input type="text" class="required" readonly name="taccstart" id="titem" size="5" title="Name" />
				            <?php echo anchor_popup(site_url("accountc/get_list/"), '[ ... ]', $atts1); ?>  &nbsp; - &nbsp;
						   
						    <input type="text" class="required" readonly name="taccend" id="titem2" size="5" title="Name" />
				            <?php echo anchor_popup(site_url("accountc/get_list/null/null/titem2"), '[ ... ]', $atts1); ?> <br />
						</td> 						
					</tr>
