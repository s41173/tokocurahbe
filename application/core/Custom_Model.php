...
class Custom_Model extends CI_Model {
    ...
    protected function cek_orderbyl($field="",$ordering='desc')
    {
        if ($field == ""){return $this->db->order_by('id', $ordering); ;}
        elseif ($field == '0'){ return $this->db->order_by('id', $ordering); }
        else {return $this->db->order_by($field, $ordering); $this->db->where($field, $val);}
    }
